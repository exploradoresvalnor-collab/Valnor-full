...
export function EnergyBar() {
  ...
  return (
    <div className={`energy-bar-container ${isFull ? 'full' : ''}`} title={!isFull ? `+1 en ${timeToNext}` : 'Energía al máximo'}>
      ...
      <div className="energy-status-container">
        {isFull ? (
          <span className="energy-full-text">✓ LLENO</span>
        ) : (
          <div className="energy-regen-compact">
            <span className="regen-time">{timeToNext}</span>
            <div className="regen-progress-mini">
              <div
                className="regen-progress-mini-fill"
